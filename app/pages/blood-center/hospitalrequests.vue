...
/* ===========================================================
   RedAgos - Blood Center Portal
   Page: Blood Inventory
   Converted from React -> Nuxt 3 / Vue 3 <script setup>
   Follows established conventions:
   - no Tailwind, scoped CSS custom properties
   - shimmer skeleton loading
   - dynamic dropdown data from centerService (never hardcoded)
   - fadeInUp stagger animation with --delay
   - dark mode via :global(.dark .classname)
=========================================================== */
...
<template>
  <div class="inventory-page">
    ...
    <div class="page-header">
      <div>
        <p class="breadcrumb">Dashboard / Blood Inventory</p>
...
<style scoped>
/* ===========================================================
   Design tokens (matches RedAgos design system)
=========================================================== */
.inventory-page {
  --primary: #1565c0;
  --accent: #d32f2f;
