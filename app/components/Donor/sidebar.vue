...
const router = useRouter() // needed for logout
const mobileOpen = ref(false)
const eligibilityStatus = ref(null)

// Keep clearUser from your version
...
const navGroups = [
  {
    label: null,
    items: [
      // Lowercase paths (Yannie's version)
...
// Keep your user menu and logout functionality
const bottomItems = [
...
// Keep Yannie's navStyle (better dark mode and active indicator)
const navStyle = (path) => {
