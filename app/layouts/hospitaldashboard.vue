...
// --- Notifications ---
// // Dev note: i-connect ni sa notifications unread-count endpoint
const unreadCount = ref(0)

// --- Profile dropdown ---
const showUserMenu = ref(false)
const userMenuItems = [
  { label: 'Blood Requests', path: '/hospital/requests', icon: 'clipboard-list' },
...
const searchablePages = [
  ...
  { label: 'Blood Requests', path: '/hospital/requests', icon: 'clipboard-list', keywords: 'requests pending processing' },
  { label: 'New Request', path: '/hospital/requests/new', icon: 'file-plus', keywords: 'new request create blood' },
